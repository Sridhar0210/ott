...
import 'package:ott_platform/login.dart';
import 'package:ott_platform/toast.dart';
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              prefixIcon: Icon(Icons.person,color: b1,),
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            obscureText: widget.isPasswordField == true? _obscureText : false,
                            decoration: InputDecoration(
                              prefixIcon: Icon(Icons.mail,color: b1,),
                              border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(15)
                              ),
                              suffixIcon: new GestureDetector(
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              prefixIcon: Icon(Icons.password,color: b1,),
                              border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(15)
                              ),
                              suffixIcon: new GestureDetector(
